...
RcppExport SEXP _rcpp_module_boot_Unscaled_nuts_faciModule();
RcppExport SEXP _rcpp_module_boot_Unscaled_nuts_loopsModule();
RcppExport SEXP _rcpp_module_boot_Unscaled_nuts_plantModule();
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_rcpp_module_boot_Unscaled_nuts_faciModule", (DL_FUNC) &_rcpp_module_boot_Unscaled_nuts_faciModule, 0},
    {"_rcpp_module_boot_Unscaled_nuts_loopsModule", (DL_FUNC) &_rcpp_module_boot_Unscaled_nuts_loopsModule, 0},
    {"_rcpp_module_boot_Unscaled_nuts_plantModule", (DL_FUNC) &_rcpp_module_boot_Unscaled_nuts_plantModule, 0},
    {NULL, NULL, 0}
};
