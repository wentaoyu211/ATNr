...
class Unscaled_nuts_faci{ // adding facilitation process to G:realized growth rate
public:
  ...
  Unscaled_nuts_faci(int ns, int nb, int nn): // should probably add facilitation matrix to the argument???
...
RCPP_MODULE(Unscaled_nuts_faciModule){
  using namespace Rcpp;
  class_<Unscaled_nuts_faci>("Unscaled_nuts_faci")
    .constructor<int, int, int>("constructor") //constructor
    .method("print", &Unscaled_nuts_faci::print)
    .method("ODE", &Unscaled_nuts_faci::ODE)
    .method("initialisations", &Unscaled_nuts_faci::initialisations)
    .field("nb_s", &Unscaled_nuts_faci::nb_s)
    .field("nb_b", &Unscaled_nuts_faci::nb_b)
    .field("nb_n", &Unscaled_nuts_faci::nb_n)
    .field("BM", &Unscaled_nuts_faci::BM)
	.field("faci", &Unscaled_nuts_faci::faci)
	.field("theta", &Unscaled_nuts_faci::theta)
    .field("K", &Unscaled_nuts_faci::K)
    .field("D", &Unscaled_nuts_faci::D)
    .field("S", &Unscaled_nuts_faci::S)
    .field("r", &Unscaled_nuts_faci::r)
    .field("X", &Unscaled_nuts_faci::X)
    .field("e", &Unscaled_nuts_faci::e)
    .field("w", &Unscaled_nuts_faci::w)
    .field("b", &Unscaled_nuts_faci::b)
    .field("c", &Unscaled_nuts_faci::c)
    .field("q", &Unscaled_nuts_faci::q)
    .field("V", &Unscaled_nuts_faci::V)
    .field("dB", &Unscaled_nuts_faci::dB)
    .field("F", &Unscaled_nuts_faci::F)
    .field("h", &Unscaled_nuts_faci::h)
    .field("fw", &Unscaled_nuts_faci::fw)
    .field("ext", &Unscaled_nuts_faci::ext)
    ;  
}
